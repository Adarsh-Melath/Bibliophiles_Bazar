...
public class VendorController {
    ...
    public ResponseEntity<VendorApplicationResponse> getMyApplication(@RequestParam String email) {
        VendorApplicationResponse application = vendorService.getByEmail(email);
        if (application == null) {
